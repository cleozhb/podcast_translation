...
FEEDS = [
    ...
    # 🔄 第四轮：替换为确定可用的同领域播客
    ("科技", "The AI Podcast (NVIDIA)", "https://feeds.soundcloud.com/users/soundcloud:users:264034133/sounds.rss"),
    ("科技", "Gradient Dissent → Weights & Biases Blog", "https://wandb.ai/site/podcast/feed.xml"),
    ("科技", "Software Engineering Daily", "https://softwareengineeringdaily.com/feed/podcast/"),
    ("科技", "Command Line Heroes (Red Hat)", "https://feeds.pacific-content.com/commandlineheroes"),
    ("科技", "Techmeme Ride Home", "https://www.techmeme.com/feed.xml"),
    ("科技", "ThursdAI", "https://api.substack.com/feed/podcast/1084089.rss"),
    ...
    ("商业", "Prof G Markets (Scott Galloway)", "https://feeds.megaphone.fm/profgmarkets"),
    ...
    # 替换为确定可用的同领域播客
    ("商业", "The Diary of a CEO (Steven Bartlett)", "https://feeds.megaphone.fm/DVLP3337691883"),
    ("商业", "Acquired (商业史)", "https://acquired.libsyn.com/rss"),
    ("商业", "StartUp Podcast (Gimlet)", "https://feeds.megaphone.fm/startup"),
    ("商业", "Marketplace (APM)", "https://www.marketplace.org/feed/podcast/marketplace"),
    ...
    # 🔄 第四轮替换
    ("生命科学", "Nature Podcast (Acast)", "https://feeds.acast.com/public/shows/612ade8c3bff2f0013d8ab07"),
    ("生命科学", "TWIV (This Week in Virology)", "https://twiv.libsyn.com/rss"),
    # 替换为确定可用的同领域播客
    ("生命科学", "The Readout Loud (STAT News)", "https://art19.com/shows/the-readout-loud/episodes.rss"),
    ("生命科学", "NEJM → Lancet Clinical Briefing", "https://feeds.libsyn.com/479756/rss"),
    ("生命科学", "In Those Genes (遗传学)", "https://feeds.simplecast.com/SvKdt0V1"),
    ("生命科学", "Sean Carroll's Mindscape", "https://www.preposterousuniverse.com/podcast.xml"),
    ("生命科学", "StarTalk with Neil deGrasse Tyson", "https://feeds.simplecast.com/4T39_jAj"),
