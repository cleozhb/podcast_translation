...
使用方法:
    ...
    python rss_validator.py --timeout 30
...
FEEDS = [
    ...
    ("科技", "This Week in Startups", "https://feeds.simplecast.com/4MvgQ73R"),
    ("科技", "TWIML (This Week in ML & AI)", "https://twimlai.libsyn.com/rss"),
    ("科技", "Decoder with Nilay Patel", "https://feeds.simplecast.com/7y1CbAbN"),
    ("科技", "Eye on AI", "https://www.eye-on.ai/podcast-archive?format=rss"),
    ("科技", "The Robot Brains Podcast", "https://therobotbrains.ai/feed/"),
    ("科技", "Gradient Dissent (W&B)", "https://feeds.transistor.fm/gradient-dissent"),
    ("科技", "No Priors: AI, ML, Tech", "https://feeds.libsyn.com/499616/rss"),
    ("科技", "Tech Won't Save Us", "https://techwontsave.us/feed/podcast/techwontsaveus"),
    ("科技", "Clockwise", "https://feeds.relay.fm/clockwise"),
    ("科技", "Wired AI", "https://feeds.acast.com/public/shows/wired-ai"),
    ("科技", "Sharp Tech (Ben Thompson)", "https://feeds.megaphone.fm/sharptech"),
    ("科技", "Latent Space (替代已停更的Exponent)", "https://feeds.buzzsprout.com/2004620.rss"),
    ...
    ("商业", "The All-In Podcast", "https://feeds.simplecast.com/wgl4xEgL"),
    ("商业", "HBR IdeaCast", "https://feeds.buzzsprout.com/2244956.rss"),
    ("商业", "The Prof G Pod (Scott Galloway)", "https://feeds.simplecast.com/biNhEgaO"),
    ("商业", "My First Million", "https://feeds.simplecast.com/5lK_bZzr"),
    ("商业", "Business Wars", "https://rss.art19.com/business-wars"),
    ("商业", "Odd Lots (Bloomberg)", "https://feeds.simplecast.com/jMr2CWTV"),
    ("商业", "Lenny's Podcast", "https://feeds.transistor.fm/lenny-s-podcast-lennyrachitsky"),
    ("商业", "20VC with Harry Stebbings", "https://access.acast.com/rss/61d09e28a4a33b0013088482/default"),
    ...
    # 🔄 本轮替换链接
    ("生命科学", "Nature Podcast", "https://feeds.acast.com/public/shows/nature-podcast"),
    ("生命科学", "TWIV (This Week in Virology)", "https://www.microbe.tv/twiv/feed/podcast/"),
    ("生命科学", "The Long Run with Luke Timmerman", "https://feeds.transistor.fm/the-long-run-with-luke-timmerman"),
    ("生命科学", "NEJM Interviews", "https://podcasts.nejm.org/rss/audio-interview.xml"),
    ("生命科学", "The Lancet Voice", "https://feeds.buzzsprout.com/2223020.rss"),
    ("生命科学", "Cell Press Podcast", "https://feeds.buzzsprout.com/2035928.rss"),
    ("生命科学", "Genetics Unzipped", "https://geneticsunzipped.com/feed/podcast"),
    ("生命科学", "BioTech Startup Podcast", "https://feeds.simplecast.com/TfGbMBYS"),
    ("生命科学", "Mendelspod (生命科学访谈)", "https://mendelspod.com/feed/podcast"),
    ("生命科学", "BioCentury Podcast", "https://feeds.buzzsprout.com/972582.rss"),
]
